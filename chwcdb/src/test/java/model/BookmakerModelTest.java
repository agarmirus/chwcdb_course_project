...
public class BookmakerModelTest
{
    ...
    */
    ...
    @Test(expected = CHWCDBInvalidParameterException.class)
    public void addBetElementaryEnclosuresTest() throws Exception
    {
        int betId = 1;
        BetType type = BetType.ELEMENTARY;
        String condition = "1";
        ...
        List<Bet> elemBets = new ArrayList<Bet>();
        elemBets.add(new Bet());

        var bet = new Bet(betId, type, condition, coefficient, gameId);
        bet.setBets(elemBets);
    ...
    @Test(expected = CHWCDBInvalidParameterException.class)
    public void addBetExpressElemNullCondition() throws Exception
    {
        int betId = 1;
        BetType type = BetType.EXPRESS;

        var elemBet1 = new Bet(1, BetType.ELEMENTARY, "1", 1.4, 1);
        var elemBet2 = new Bet(2, BetType.ELEMENTARY, null, 2.5, 13);
    ...
    @Test(expected = CHWCDBInvalidParameterException.class)
    public void addBetExpressElemEmptyCondition() throws Exception
    {
        int betId = 1;
        BetType type = BetType.EXPRESS;

        var elemBet1 = new Bet(1, BetType.ELEMENTARY, "1", 1.4, 1);
        var elemBet2 = new Bet(2, BetType.ELEMENTARY, "", 2.5, 13);
    ...
    @Test(expected = CHWCDBInvalidParameterException.class)
    public void addBetExpressElemInvalidCoefCondition() throws Exception
    {
        int betId = 1;
        BetType type = BetType.EXPRESS;

        var elemBet1 = new Bet(1, BetType.ELEMENTARY, "1", 1.4, 1);
        var elemBet2 = new Bet(2, BetType.ELEMENTARY, "1", 0.5, 13);
    ...
    @Test(expected = CHWCDBInvalidParameterException.class)
    public void addBetExpressElemNegGameIdTest() throws Exception
    {
        int betId = 1;
        BetType type = BetType.EXPRESS;
    ...
    @Test(expected = CHWCDBInvalidParameterException.class)
    public void addBetExpressElemEnclosureBetsCondition() throws Exception
    {
        int betId = 1;
        BetType type = BetType.EXPRESS;
    ...
    @Test(expected = CHWCDBInvalidParameterException.class)
    public void addBetSystemExpressNullBetsTest() throws Exception
    {
        int betId = 1;
        BetType type = BetType.SYSTEM;
        ...
        var express1 = new Bet(1, BetType.EXPRESS, elemBets1);
        var express2 = new Bet(2, BetType.EXPRESS, null);
    ...
    @Test(expected = CHWCDBInvalidParameterException.class)
    public void addBetSystemExpressEmptyBetsTest() throws Exception
    {
        int betId = 1;
        BetType type = BetType.SYSTEM;
    ...
    @Test(expected = CHWCDBInvalidParameterException.class)
    public void addBetSystemElementaryNullConditionTest() throws Exception
    {
        int betId = 1;
        BetType type = BetType.SYSTEM;
    ...
    @Test(expected = CHWCDBInvalidParameterException.class)
    public void addBetSystemElementaryEmptyConditionTest() throws Exception
    {
        int betId = 1;
        BetType type = BetType.SYSTEM;
    ...
    @Test(expected = CHWCDBInvalidParameterException.class)
    public void addBetSystemElementaryInvalidCoefTest() throws Exception
    {
        int betId = 1;
        BetType type = BetType.SYSTEM;
    ...
    @Test(expected = CHWCDBInvalidParameterException.class)
    public void addBetSystemElementaryNegGameIdTest() throws Exception
    {
        int betId = 1;
        BetType type = BetType.SYSTEM;
    ...
    @Test(expected = CHWCDBInvalidParameterException.class)
    public void addBetSystemElementaryEnclosureBetsTest() throws Exception
    {
        int betId = 1;
        BetType type = BetType.SYSTEM;
        ...
        List<Bet> encElemBets = new ArrayList<Bet>();
        encElemBets.add(new Bet());

        elemBet2.setBets(encElemBets);
